...
function App() {
    ...
    return (
        <Container>
            ...
            <RightSide>
                <Input width={15} label='Sifra Pacanja' value={payCode} whenChanged={onPayCodeChange} />
                <Input width={15} label='Valuta' value={currencyCode} whenChanged={onCurrencyCode} />
                <Input width={70} label='Iznos' value={totalAmount} whenChanged={onTotalAmountChange} />
